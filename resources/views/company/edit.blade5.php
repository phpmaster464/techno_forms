                ...
                <form class="form-horizontal" method="post" action="{{ route('company.update',$company->id) }}"
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12 mb-3">
                        <div class="form-group">
                            <label for="CompanyName" class="col-md-3 col-12 control-label">Name</label>
                        ...
                        <div class="form-group">
                            <label for="CompanyPrimaryEmailAddress "
                                class="company-primary-lable col-md-3 col-12 control-label">Primary Email Address </label>
                            <div class="col-md-9 col-12">
                                <input type="email" class="form-control" id="CompanyPrimaryEmailAddress"
                                    ...
                                    value="{{$company->company_primary_email}}">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                            <label for="CompanySecondaryEmailAddress" class="col-md-3 col-12 control-label"> Secondary Email Address</label>
                            <div class="col-md-9 col-12">
                                <input type="email" class="form-control" id="CompanySecondaryEmailAddress"
                                    ...
                                    value="{{$company->company_secondary_email}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="CompanyWebsite" class="col-md-3 col-12 control-label">Website</label>
                            <div class="col-md-9 col-12">
                        ...
                        <div class="form-group">
                            <label for="CompanyDescription" class="col-md-3 col-12 control-label">Description</label>
                            <div class="col-md-9 col-12">
                          ...
                          <div id="container" class="form-group">
                            <label for="CompanyStatus" class="col-md-3 col-12 control-label">status</label>
                            <div class="col-md-9 col-12">
                                ...
                                <div class="col-sm-2 col-12">
                                    <div class="switch" id="submit">
                                        ...
                                        <input type="checkbox" checked id="switch-2"
                                            onclick="update_company_status($(this),'edit_company_status');">
                                        @else
