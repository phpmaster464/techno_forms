                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 mb-3 text-center">
                        <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                ...
                                @if(isset($job->installer_signature) && $job->installer_signature !='')
                                <div id="imagePreview_installer"
                                    style="background-image: url({{ URL::to('/') }}/{{$job->installer_signature}});">
                                </div>
                                @else
                                <div id="imagePreview_installer"
                                    style="background-image: url({{URL::to('/')}}/assets/images/no-sign.png);">
                                </div>
                                @endif
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 mb-3 text-center">
                        <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                ...
                                @if(isset($job->designer_signature) && $job->designer_signature !='')
                                <div id="imagePreview_installer"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 mb-3 text-center">
                        <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                ...
                                @if(isset($job->electrician_signature) && $job->electrician_signature !='')
                                <div id="imagePreview_installer"
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="address_latitude" name="address_latitude" value="{{$job->address_latitude}}">

                                        <input type="hidden" id="address_longitude" name="address_longitude" value="{{$job->address_longitude}}" >
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="installation_address_latitude"  name="installation_address_latitude" value="{{$job->installation_address_latitude}}">
                                        <input type="hidden" id="installation_address_longitude" name="installation_address_longitude" value="{{$job->installation_address_longitude}}">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                            <div class="form-group autocomplete">
                                                ...
                                                <input type="hidden" value="" name="panel_id[]">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                            <div class="form-group autocomplete">
                                                ...
                                                <input type="hidden" value="" name="inverter_id[]">
                                ...
                                <div class="owner-details-wrappertwo">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                            <div class="form-group  autocomplete">
                                                <label for="Title" class="control-label"> Quick Search: </label>
                                                <input type="hidden" value="{{$inverter->id}}" name="inverter_id[]">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 mb-3"  id="panel_serial">
                                    <div class="form-group">
                                        ...
                                        <div id="Panel_Serial_Numbers{{$i}}" class="d-flex mb-2 align-items-center ">
                                            <input type="hidden" name="Panel_sid[{{$key}}][]" value="{{$panel->panel_serial_no_scanned[$pkey]['panel_sid']}}">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 mb-3" id="invetrers_serial">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="Invetrers_sid[{{$key}}][]" value="{{$inverter->inverter_serial_no_scanned[$ikey]['inverter_sid']}}">
