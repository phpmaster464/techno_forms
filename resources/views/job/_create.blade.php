                    ...
                    <div class="job-form-wrapper">
                        ...
                        <div class="owner-details-wrapper">
                            ...
                            <div class="row" id="SearchAddressdiv2" style="display:none;">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="story" class="control-label"> Story Type:<span
                                                class="mdi mdi-multiplication"></span></label>
                                        <select class="form-control" id="story" name="=owner_story_type">
                                            <option value="">Select</option>
                                            <option>a</option>
                                            <option>b</option>
                                        </select>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="property" class="control-label"> Property Type:<span
                                                class="mdi mdi-multiplication"></span></label>
                                        <select class="form-control" id="property" name="owner_property_type">
                                            <option value="">Select</option>
                                            <option>p1</option>
                                            <option>p2</option>
                                        </select>
                        ...
                        <div class="rate-dpower-wrapper" id="advanceInstaller">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                    <div class="form-group d-flex align-items-center ">
                                            ...
                                            <input type="checkbox" name="replacing_panels" value="yes" style="margin: 5px 10px 5px 10px;">Yes
                                            <input type="checkbox" name="replacing_panels" value="no" style="margin: 5px 10px 5px 10px;">No
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                    <div class="form-group d-flex align-items-center">
                                            ...
                                            <input type="checkbox" name="Additionalpanels" value="yes" style="margin: 5px 10px 5px 10px;">Yes
                                            <input type="checkbox" name="Additionalpanels" value="no" style="margin: 5px 10px 5px 10px;">No
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-12 mb-3">
                                    <div class="form-group d-flex align-items-center">
                                            ...
                                            <input type="checkbox" name="system_installed" value="yes" style="margin: 5px 10px 5px 10px;">Yes
                                            <input type="checkbox" name="system_installed" value="no" style="margin: 5px 10px 5px 10px;">No
                                    </div>
                                </div>
                                        </div>
