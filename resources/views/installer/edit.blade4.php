           ...
           <div class="form-group">
            ...
            <div class="col-md-9 col-12">
                 ...
                 @if ($type != '' && in_array("Installer", $type))
                    <input name="type[]" class="type1" type="checkbox" value="Installer" checked=""><label for="CompanySecondaryEmailAddress" class="control-label type11">&nbsp;&nbspInstaller&nbsp;&nbsp;</label>
                @else
                ...
                @if ($type != '' && in_array("Gas Fitter", $type))
                   <input name="type[]" class="type2" type="checkbox" value="Gas Fitter" checked=""><label for="CompanySecondaryEmailAddress" class="control-label type22">&nbsp;&nbsp;Gas Fitter&nbsp;&nbsp</label> 
                @else
