    ...
    function generate_pdf(){
        ...
        html2canvas(document.body, { 
           ...
           //document.body.appendChild(div);
                ...
                $(".quick_search").on("keyup",function(){
                    ...
                    console.log(keyword);
                        ...
                        success:function(data)
                        {
                            ...
                            if(data.length >0){   
                                autocomplete(document.getElementById("install_date"), data);
                            }
                        }
                    });
			...
			$("#Panels_Brand").html('<option value="">Select</option><option value="'+brand+'" selected>'+brand+'</option>');
                        $("#Panels_Model").html('<option value="">Select</option><option value="'+watt+'" selected>'+watt+'</option>');
                    });
                }
                ...
                /*initiate the autocomplete function on the "install_date" element, and pass along the countries array as possible autocomplete values:*/
                //autocomplete(document.getElementById("install_date"), countries);
