		  	...
		  	$job_id = $value->job_id;
                ...
                $panel_fields_serials[$key][$i] = array('serial'=> '','scanned'=>'','panel_iamge'=>'');
                  ...
                  //if(count($panel_serial_numbers) > 0){
                    ...
                    //die;	
                //}
		    //echo "<pre>";print_r($panel_fields_serials);
              ...
              $panel_image_count  = isset($panel_image_count)&&$panel_image_count>0?$panel_image_count:0;
		...
		$j = 0;
			...
			$inverter_id = $value->id;
		  	$job_id = $value->job_id;
                ...
                $inverter_fields_serials[$key][$i] = array('serial'=>'','scanned'=>'','inverter_image'=>'');
                ...
                for($p=0;$p<$value->Enter_number_of_inverter;$p++)
		  		{
                    ...
                    if(isset($invetrers_serial_numbers[$p]) && $invetrers_serial_numbers[$p] !=''){
                        ...
                        $inverter_fields_serials[$key][$p] = array('serial'=>'','scanned'=>'','inverter_image'=>'');
                    }
              ...
              //echo "<pre>";print_r($inverters);echo "<pre>";print_r($panels);die;
              $inverter_image_count = isset($inverter_image_count)&&$inverter_image_count>0?$inverter_image_count:0;
